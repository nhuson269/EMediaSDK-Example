...
class WelcomeViewController: UIViewController {
    ...
    @IBAction func serverTapped(_ sender: UIButton) {
        ...
        alert.addAction(UIAlertAction(title: "OK", style: .default, handler: { [weak alert] (_) in
            ...
            EMediaClient.printf("Text field: \(textValue)")
    ...
    private func getMode() -> EMediaClientMode {
        switch self.modeSelection.selectedSegmentIndex {
            case 0:
                return EMediaClientMode.join
            case 1:
                return EMediaClientMode.play
            case 2:
                return EMediaClientMode.publish
            case 3:
                return EMediaClientMode.conference
            default:
                return EMediaClientMode.join
        }
    }
    ...
    {
        if self.getMode() != EMediaClientMode.conference {
