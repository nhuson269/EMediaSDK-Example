...
class SampleHandler: RPBroadcastSampleHandler, EMediaClientDelegate {
    ...
    override func broadcastStarted(withSetupInfo setupInfo: [String : NSObject]?) {
        ...
        else if ((url) == nil)
        {
            ...
            self.client.setOptions(url: url as! String, streamId: streamId as! String, token: token as? String ?? "", mode: EMediaClientMode.publish, enableDataChannel: true, captureScreenEnabled: true);
